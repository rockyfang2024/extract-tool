...
建议分支/提交信息（若要在仓库中合并）：
- 分支名：feat/web-ui-wechat-extract
- 提交信息：Add Flask web UI and settings for wechat_extract
...
- 容器化：可以为该项目添加 Dockerfile，将 Python 依赖安装并以 gunicorn 启动 app.py；我可以根据需要为你生成 Dockerfile 和 docker-compose 配置。
